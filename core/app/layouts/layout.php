...
<html>
  <head>
    <meta charset="UTF-8">
    <title>RappyRanch | Nayarit</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">Rappy<b>Ranch</b></span>
        </a>
...
<?php endif;?> 
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  if(Core::$user->kind==1){ echo " (Con todo Inge )"; } // aqui van los usuarios a administrar comprador 
                  else if(Core::$user->kind==2){ echo " (Almacenista)"; }
                  else if(Core::$user->kind==3){ echo " (Vendedor)"; }
                  else if(Core::$user->kind==4){ echo ""; }
...
<?php if(isset($_SESSION["user_id"])):?>
                      ...
                      <a href="./?view=profile" class="btn btn-default btn-flat">Mi cuenta</a>
                    <?php endif; ?>
...
<?php if(Core::$user->kind==1||Core::$user->kind==3||Core::$user->kind==4):?>
            <li><a href="./?view=sellnew"><i class='fa fa-eye'></i> <span>Ver Pedido</span></a></li>
            <li class="treeview <?php if(isset($_GET["view"]) && ($_GET["view"]=="users"||$_GET["view"]=="settings" ||$_GET["view"]=="import"||$_GET["view"]=="newuser"||$_GET["view"]=="edituser")){ echo "active"; }?>">
              <a href="#"><i class='fa fa-shopping-cart'></i> <span>Realizar Pedido</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="./?view=comidaa">Encargar Comida</a></li>
                <li><a href="./?view=users">Pagar Servicios</a></li>
                <li><a href="./?view=users"> Rappy Mandados</a></li>
               

              </ul>
            </li>
            <li class="treeview <?php if(isset($_GET["view"]) && ($_GET["view"]=="users"||$_GET["view"]=="settings" ||$_GET["view"]=="import"||$_GET["view"]=="newuser"||$_GET["view"]=="edituser")){ echo "active"; }?>">
              <a href="#"><i class='fa fa-user'></i> <span>Registrarme</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="./?view=users">Crear Mi Usuario</a></li>
...
<?php if(Core::$user->kind==1):?>
            ...
            <li class="treeview <?php if(isset($_GET["view"]) && ($_GET["view"]=="users"||$_GET["view"]=="settings" ||$_GET["view"]=="import"||$_GET["view"]=="newuser"||$_GET["view"]=="edituser")){ echo "active"; }?>">
              <a href="#"><i class='fa fa-cog'></i> <span>DATOS</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
               
                <li><a href="./?view=users">Agregar Menu</a></li>
...
<?php if(Core::$user->kind==1||Core::$user->kind==4):?>
          ...
          <?php endif; ?>
            <?php if(Core::$user->kind==1):?>
            <li class="treeview  <?php if(isset($_GET["view"]) && ($_GET["view"]=="credit"||$_GET["view"]=="makepayment" ||$_GET["view"]=="paymenthistory"||$_GET["view"]=="balance"||$_GET["view"]=="spends"||$_GET["view"]=="newspend"||$_GET["view"]=="editspend"||$_GET["view"]=="deposits"||$_GET["view"]=="newdeposit"||$_GET["view"]=="editdeposit")){ echo "active"; }?>">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=deposits">Depositos/Ajustes</a></li>
          ...
          <?php endif; ?>
            <li class="treeview  <?php if(isset($_GET["view"]) && ($_GET["view"]=="inventary"||$_GET["view"]=="search" ||$_GET["view"]=="inventaries"||$_GET["view"]=="selectstock"||$_GET["view"]=="inventaryval"||$_GET["view"]=="dev"||$_GET["view"]=="trasps"||$_GET["view"]=="devs"||$_GET["view"]=="re"||$_GET["view"]=="traspase"||$_GET["view"]=="onetraspase"||$_GET["view"]=="onedev")){ echo "active"; }?>">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=inventary2&stock=<?php echo StockData::getPrincipal()->id;?>">Inventario Principal v2</a></li>
...
<div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <center><h5>
¡Gracias por visitarnos! deceamos que puedas efectuar una compra dentro de esta aplicación de MotoMandados. Nuestro objetivo es que siempre estés al tanto de tu encargo ¡Que tengas un gran día! </h5></center>
<center><h5>
Es necesario ingresar con los accesos de membresia [usuario y contraseña]. una vez ingresado puedes darte de alta con tus datos personales  si asi lo deceas.</h5></center>
          <div class="form-group has-feedback">
          
            <input type="text" name="name" required class="form-control" placeholder="Usuario =  Xala01" disabled/>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
          
          <input type="text" name="name" required class="form-control" placeholder="Contraseña =  Xala01" disabled/>
        ...
        <form action="./?action=processlogin" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              ...
              <a href="./?view=clientaccess" class="btn btn-default btn-block btn-flat"> Regalo de Membresia  <i class="fa fa-arrow-right"></i> </a>
