<?php
$kind = "";
if($_GET["kind"]=="1"){ $kind = "Administrador"; }
else if($_GET["kind"]=="2"){ $kind = "Almacenista"; }
else if($_GET["kind"]=="3"){ $kind = "Vendedor"; }
else if($_GET["kind"]=="4"){ $kind = "Administrador de Sucursalb"; }
?>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="lastname" class="form-control" id="lastname" placeholder="Celular">
    </div>
  </div>
  <div class="form-group">
...
<?php if(isset($_GET["kind"]) &&$_GET["kind"]=="2" || $_GET["kind"]=="3"|| $_GET["kind"]=="4"):?>
  <div class="form-group">
