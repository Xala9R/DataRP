...
<!--  <td><?php echo $product->unit; ?></td> -->
  <td><?php echo $product->code; ?> - <?php echo $product->name; ?></td>
<!--  <td><b><?php echo $symbol; ?> <?php echo number_format($p["price"],2,".",","); ?></b></td>
  ...
  <td style="width:30px;"><a id="clearcart-<?php echo $product->id; ?>" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
...
<p class="text-muted">Acceso con Email, Password y Acceso Activado</p>
    </div>
    </div>
